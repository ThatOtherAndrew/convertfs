...
class AudioConverter(Converter):
    ...
    def process(self, source: Path, requested: Path) -> bytes:
        ...
        if top == 'quality':
            ...
            return self._transcode(source, ext, bitrate=bitrate)
        ...
        if top == 'bitrate':
            ...
            return self._transcode(source, 'mp3', bitrate=kbps * 1000)
    ...
    def _transcode(
        ...
        *,
        ...
        with av.open(str(source), 'r') as input_container:
            ...
            with av.open(buf, 'w', format=container) as output_container:
